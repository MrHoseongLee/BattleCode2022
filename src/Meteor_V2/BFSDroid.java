...
public class BFSDroid extends BFS {
    ...
    protected Direction getBestDir(MapLocation target) throws GameActionException {
        ...
        if (dx > 0 && dy > 0) { return getBestDir0(target); }
        if (dx < 0 && dy > 0) { return getBestDir1(target); }
        if (dx > 0 && dy < 0) { return getBestDir2(target); }
        if (dx < 0 && dy < 0) { return getBestDir3(target); }
        if (dx == 0 && dy > 0) { return getBestDir4(target); }
        if (dx == 0 && dy < 0) { return getBestDir5(target); }
        if (dx > 0 && dy == 0) { return getBestDir6(target); }
        if (dx < 0 && dy == 0) { return getBestDir7(target); }
    ...
    private Direction getBestDir4(MapLocation target) throws GameActionException {
        l34 = rc.getLocation();
        v34 = 0; 
        l43 = l34.add(Direction.EAST);
        v43 = 1000000;
    ...
    private Direction getBestDir5(MapLocation target) throws GameActionException {
        l34 = rc.getLocation();
        v34 = 0; 
        l35 = l34.add(Direction.NORTH);
        v35 = 1000000;
    ...
    private Direction getBestDir6(MapLocation target) throws GameActionException {
        l34 = rc.getLocation();
        v34 = 0; 
        l43 = l34.add(Direction.EAST);
        v43 = 1000000;
    ...
    private Direction getBestDir7(MapLocation target) throws GameActionException {
        l34 = rc.getLocation();
        v34 = 0; 
        l43 = l34.add(Direction.EAST);
        v43 = 1000000;
